...
namespace DistrEx.Coordinator
{
    ...
    {
        public static CompletedStep<Tuple<TNextResult1, TNextResult2, TNextResult3, TNextResult4, TNextResult5, TNextResult6>>
                ThenDo<TResult, TNextResult1, TNextResult2, TNextResult3, TNextResult4, TNextResult5, TNextResult6>(
        ...
        {
            return Coordinator.Do(targetedInstruction1, targetedInstruction2, targetedInstruction3, targetedInstruction4, targetedInstruction5, targetedInstruction6, step.ResultValue);
        }
    }
}
