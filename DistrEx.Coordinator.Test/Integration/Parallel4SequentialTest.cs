...
namespace DistrEx.Coordinator.Test.Integration
{
    ...
    public class Parallel4SequentialTest
    {
        ...
        private Instruction<Tuple<int, int, int, int>, Tuple<int, int, int, int>> _identityTpl;
        ...
        public void Test()
        {
            ...
            Tuple<Tuple<int, int, int, int>, Tuple<int, int, int, int>, int, int> result =
                Coordinator4.Do(
                    Coordinator.Do(_local.Do(_identity))
                               .ThenDo(_local.Do(_identity),
                                       ...
                                       _local.Do(_identity),
                                       _local.Do(_identity)),
                    Coordinator4.Do(_local.Do(_identity),
                                    _local.Do(_identity),
                                    _local.Do(_identity),
                                    _local.Do(_identity))
