...
namespace DistrEx.Coordinator.Test.Parallel
{
    ...
    public class Parallel4Test
    {
        ...
        public void ParallelAllSimultaneous()
        {
            ...
            Task<Tuple<Exception, Exception, Exception, Exception>> task = Task<Tuple<Exception, Exception, Exception, Exception>>.Factory.StartNew(() => GetResult(instructions, _identityArgument));
        ...
        private Tuple<Exception, Exception, Exception, Exception> GetResult(TargetedInstruction<Exception, Exception>[] instructions, Exception argument)
        {
            return Coordinator4.Do(instructions[0], instructions[1], instructions[2], instructions[3], argument).ResultValue;
        }
