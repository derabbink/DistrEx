...
{
    [TestFixture]
    public class Parallel6Test
    {
        private const int ParallelCount = 6;
        ...
        public void ParallelAllSimultaneous()
        {
            ...
            Task<Tuple<Exception, Exception, Exception, Exception, Exception, Exception>> task = Task<Tuple<Exception, Exception, Exception, Exception, Exception, Exception>>.Factory.StartNew(() => GetResult(instructions, _identityArgument));
        ...
        private Tuple<Exception, Exception, Exception, Exception, Exception, Exception> GetResult(TargetedInstruction<Exception, Exception>[] instructions, Exception argument)
        {
            return Coordinator6.Do(instructions[0], instructions[1], instructions[2], instructions[3], instructions[4], instructions[5], argument).ResultValue;
        }
